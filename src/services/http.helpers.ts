...
export const httpPost = <T>(url: string, body?: unknown) => http<T>(url, { method: 'POST', body });

export const httpPut = <T>(url: string, body?: unknown) => http<T>(url, { method: 'PUT', body });

export const httpPatch = <T>(url: string, body?: unknown) =>
	http<T>(url, { method: 'PATCH', body });
