...
import { useAssignmentDetail, useUpdateAssignment } from '@/hooks/queries/assignment/use-assignment-query';
					...
					<form onSubmit={handleSave} className="space-y-5 py-4">
						...
						<div>
							...
							<select
								...
								disabled={!isEditable || updateMutation.isPending || isSubjectsLoading || isSubjectsError}
							>
