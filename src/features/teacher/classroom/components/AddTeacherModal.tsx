...
export function AddTeacherModal({ open, onOpenChange, classId, onSuccess }: AddTeacherModalProps) {
	...
	const _filteredTeachers = availableTeachers.filter(
		(teacher) =>
			teacher.userName?.toLowerCase().includes(searchQuery.toLowerCase()) ||
			teacher.email?.toLowerCase().includes(searchQuery.toLowerCase()),
	);

	const _handleAddTeacher = async () => {
