  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-[#E0DCD5] shadow-sm">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="w-11 h-11 rounded-2xl flex items-center justify-center" style={{ backgroundColor: color }}>
    ...
    <div className="min-h-screen bg-[#FAF9F6] grid-paper">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title="Total Quizzes" value={overview?.totalQuizzes ?? 0} icon={ClipboardList} color="#F5B041" />
          <StatCard title="Total Assignments" value={overview?.totalAssignments ?? 0} icon={FileText} color="#C5B4E3" />
          <StatCard title="Total Exams" value={overview?.totalExams ?? 0} icon={Shield} color="#A8D5BA" />
          <StatCard
