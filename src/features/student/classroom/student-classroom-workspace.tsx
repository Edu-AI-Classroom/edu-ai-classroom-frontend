...
export default function StudentClassroomWorkspace({
	...
	return (
		<div className="flex min-h-screen bg-[#FAF9F6] text-[#333]">
			...
			{/* Sidebar */}
			<aside
				className={`fixed inset-y-0 left-0 z-50 w-64 bg-white/95 shadow-xl shadow-black/5 ring-1 ring-[#E0DCD5]/70 transform transition-transform duration-300 lg:static lg:transform-none lg:shadow-none ${
