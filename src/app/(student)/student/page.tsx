...
export default function StudentHome() {
	...
	const studentFirstName = studentName.split(' ')[1] ?? studentName.split(' ')[0] ?? 'Student';
		...
		<div className="min-h-screen bg-[#FAF9F6] grid-paper">
					...
					<div className="flex items-center gap-4">
						...
						<div className="flex items-center gap-3 pl-4 border-l border-[#E0DCD5]">
							...
							<div className="hidden sm:block">
								<p className="font-sans font-semibold text-sm text-[#333]">{studentName}</p>
								<p className="text-xs text-[#666]">{studentRole}</p>
							</div>
						</div>
					</div>
				</div>
			...
			<main className="max-w-6xl mx-auto px-6 py-10">
				...
				<div className="mb-10">
					...
					<p className="font-serif text-xl text-[#666]">Ready to conquer today's lessons?</p>
				</div>
